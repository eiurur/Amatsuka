angular.module "myApp.directives"
  .directive 'maoTweetArticle', ->
    ...
    scope: {}
    template: """
      <div class="media find__media"><a twitter-id-str="{{::$ctrl.item.user.id_str}}" show-tweet="show-tweet" class="pull-left"><img ng-src="{{::$ctrl.item.user.profile_image_url_https}}" img-preload="img-preload" class="media-object thumbnail-img fade"/></a>
