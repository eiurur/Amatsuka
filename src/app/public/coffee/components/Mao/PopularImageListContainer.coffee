      ...
      <section class="popular-tweets row">
        <div class="col-md-4 col-sm-4 col-xs-4" ng-repeat="tweet in $ctrl.tweets">
          <div class="popular-tweet">
            <img class="lozad fade popular-tweets__img" data-src="{{::tweet.mediaUrl}}:small" data-img-src="{{::tweet.mediaUrl}}:small" tweet-id-str="{{::tweet.tweetIdStr}}" show-statuses="show-statuses" img-preload>
          </div>
        </div>
      </section>
    """
