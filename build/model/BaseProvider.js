(function() {
  ...
  module.exports = BaseProvider = (function() {
    ...
    BaseProvider.prototype.create = function(data) {
      return new Promise((function(_this) {
        return function(resolve, reject) {
          console.log(chalk.green("DBBaseProvider " + _this.Model.modelName + " create"));
          console.time(_this.Model.modelName + " create");
          return _this.Model.create(data, function(err, doc) {
            console.timeEnd(_this.Model.modelName + " create");
            if (err) {
              return reject(err);
            }
            return resolve(doc);
